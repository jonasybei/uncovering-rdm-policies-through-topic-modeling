...
A. the administration and management of research data (sets) in accordance with the principles and requirements of these guidelines and in accordance with the rules for ensuring good scientific practice of the Helmholtz Zentrum München (7),  

B. the collection, documentation, archiving and protection against loss of research data including researchrelated records (metadata). For this, the corresponding DMP is to be used, which specifies standard operating procedures that define the collection, administration, integrity, confidentiality, storage and publication of the data obtained.  
...
→ CC-0: https://creativecommons.org/publicdomain/zero/1.0/deed.de → CC-BY: https://creativecommons.org/licenses/by/4.0/deed.de  
